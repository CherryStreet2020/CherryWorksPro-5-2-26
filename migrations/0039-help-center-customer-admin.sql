...
-- Primary contacts keep what they had: company-wide case visibility and billing.
UPDATE client_contacts SET portal_role = 'admin', billing_access = true
 WHERE is_primary AND deleted_at IS NULL AND portal_role = 'member' AND billing_access = false;
