...
const painPoints = [
  { pain: "BigTime charges per user ($20+/user/month)", fix: "CherryWorks Pro includes unlimited users on every plan. A 20-person firm saves $4,800+/year in seat fees alone." },
  { pain: "No general ledger or accounting module", fix: "CherryWorks Pro includes a full chart of accounts, double-entry journal entries, trial balance report, and bank reconciliation — no separate accounting tool needed." },
  ...
  { pain: "No import wizard for data migration", fix: "Upload CSVs from any platform. Preview with dry-run. Execute with one click. Full rollback if anything looks wrong. Migrate in minutes." },
  ...
  { pain: "Complex UI designed for enterprise", fix: "CherryWorks Pro has a clean, modern interface that your entire team can use from day one. No training sessions required." },
];
    ...
    <div style={{ background: "#0a0f1c" }}>
      ...
      <section className="pt-[100px] pb-8 md:pb-10" style={{ background: "var(--gradient-hero)" }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-8 md:pt-12 md:pb-10">
          <div className="max-w-3xl">
            <p className="text-sm font-bold uppercase tracking-[3px] mb-4" style={{ color: "#cf3339" }}>Switch from BigTime</p>
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight leading-[1.1]">
              BigTime charges per user.{" "}
              <span style={{ color: "rgba(255,255,255,0.4)" }}>You need unlimited.</span>
            </h1>
            <p className="mt-6 text-lg md:text-xl leading-relaxed" style={{ color: "rgba(255,255,255,0.55)" }}>
              Everything BigTime does, plus a full general ledger and 1099 exports. And we don't charge you $20 per person to use it.
            </p>
      ...
      <section className="py-8 md:py-12" style={{ background: "#0a0f1c" }}>
        <div ref={painRef} className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-section">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-white">Why firms switch from BigTime</h2>
            <p className="mt-4 text-lg" style={{ color: "rgba(255,255,255,0.45)" }}>Every one of these is something BigTime can't do — or charges extra for.</p>
          </div>
      ...
      <section className="py-8 md:py-12" style={{ background: "linear-gradient(180deg, #0f172a 0%, #0a0f1c 100%)" }}>
        <div ref={compRef} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-section">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-base" style={{ color: "rgba(255,255,255,0.45)" }}>Where CherryWorks Pro wins — and where BigTime still has the edge.</p>
          </div>
          <div className="rounded-2xl overflow-hidden" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="grid grid-cols-3 text-center py-4 px-6" style={{ background: "rgba(255,255,255,0.04)" }}>
              ...
              <div><span className="text-sm font-bold" style={{ color: "rgba(255,255,255,0.5)" }}>BigTime</span></div>
            </div>
            {comparison.map((r, i) => (
          ...
          <p className="mt-6 text-sm text-center" style={{ color: "rgba(255,255,255,0.35)" }}>
            BigTime is strong for PSA. CherryWorks Pro gives you PSA plus accounting in one platform — at a fraction of the cost.
          </p>
      ...
      <section className="py-8 md:py-12" style={{ background: "#0a0f1c" }}>
        <div ref={timelineRef} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Upload, step: "1", title: "Export from BigTime", desc: "Export your clients, projects, and time entries as CSV files from BigTime's reporting tools." },
      ...
      <section className="py-8 md:py-12" style={{ background: "linear-gradient(180deg, #0f172a 0%, #0a0f1c 100%)" }}>
        <div ref={getRef} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-section">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-white" data-testid="what-you-get-heading">What $4,800/year buys you</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
      ...
      <section className="py-10 md:py-14" style={{ background: "#0a0f1c" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to switch from BigTime?</h2>
          <p className="text-lg mb-10" style={{ color: "rgba(255,255,255,0.5)" }}>
            14-day free trial. Full access. Import your BigTime data in minutes.
          </p>
          <Link href="/signup">
