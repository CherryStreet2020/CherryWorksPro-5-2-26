...
const painPoints = [
  { pain: "Harvest charges $12/user/month", fix: "CherryWorks Pro includes unlimited users on every plan. A 15-person firm saves $2,160/year in seat fees alone." },
  { pain: "No invoicing from billable time", fix: "CherryWorks Pro generates invoices directly from approved time entries. Line items link back to individual time entries for full traceability." },
  { pain: "No project profitability reports", fix: "Harvest tracks time but can't show you if projects are profitable. CherryWorks Pro calculates revenue minus labor cost minus expenses per project automatically." },
  { pain: "No 1099 + W-2 + Corp-to-Corp support", fix: "Manage all three worker classifications in one platform. Smart onboarding adapts to each type. Payouts and 1099 exports built in." },
  { pain: "No general ledger or accounting", fix: "CherryWorks Pro includes a full chart of accounts, double-entry journal entries, trial balance report, and bank reconciliation." },
  { pain: "No auto-reimbursement payouts", fix: "When you approve a reimbursable expense, CherryWorks Pro automatically creates a payout for the team member. No manual tracking." },
  { pain: "Harvest only tracks time — you need the full picture", fix: "Time → invoice → collect → pay team members → report profitability. CherryWorks Pro is the complete operating system, not just a timer." },
];
...
const comparison = [
  ...
  { feature: "Timesheet approval workflow", cw: true, comp: true },
  { feature: "Expense management", cw: true, comp: true },
  { feature: "Project profitability", cw: true, comp: true },
  { feature: "Project budget tracking", cw: true, comp: true },
  { feature: "Team utilization report", cw: true, comp: true },
  { feature: "Resource planning", cw: true, comp: false },
  { feature: "Estimates & proposals", cw: true, comp: false },
  { feature: "Enterprise audit logging", cw: true, comp: false },
];

export default function SwitchHarvestPage() {
    ...
    <div style={{ background: "#0a0f1c" }}>
      ...
      <section className="pt-[100px] pb-8 md:pb-10" style={{ background: "var(--gradient-hero)" }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-8 md:pt-12 md:pb-10">
          <div className="max-w-3xl">
            <p className="text-sm font-bold uppercase tracking-[3px] mb-4" style={{ color: "#cf3339" }}>Switch from Harvest</p>
            <h1 className="text-4xl md:text-6xl font-bold text-white tracking-tight leading-[1.1]">
              Harvest tracks time.{" "}
              <span style={{ color: "rgba(255,255,255,0.4)" }}>You need the full picture.</span>
            </h1>
            <p className="mt-6 text-lg md:text-xl leading-relaxed" style={{ color: "rgba(255,255,255,0.55)" }}>
              Harvest tracks time. That's it. You're using 3 other tools to invoice, pay team members, and close your books. We replace all four.
            </p>
      ...
      <section className="py-8 md:py-12" style={{ background: "#0a0f1c" }}>
        <div ref={painRef} className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-section">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-white">Why firms switch from Harvest</h2>
            <p className="mt-4 text-lg" style={{ color: "rgba(255,255,255,0.45)" }}>Every one of these is something Harvest can't do — or makes painfully hard.</p>
          </div>
      ...
      <section className="py-8 md:py-12" style={{ background: "linear-gradient(180deg, #0f172a 0%, #0a0f1c 100%)" }}>
        <div ref={compRef} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-section">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-base" style={{ color: "rgba(255,255,255,0.45)" }}>Where CherryWorks Pro wins — and what Harvest still does well.</p>
          </div>
          <div className="rounded-2xl overflow-hidden" style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="grid grid-cols-3 text-center py-4 px-6" style={{ background: "rgba(255,255,255,0.04)" }}>
              ...
              <div><span className="text-sm font-bold" style={{ color: "rgba(255,255,255,0.5)" }}>Harvest</span></div>
            </div>
            {comparison.map((r, i) => (
          ...
          <p className="mt-6 text-sm text-center" style={{ color: "rgba(255,255,255,0.35)" }}>
            Harvest excels at time tracking. CherryWorks Pro does time tracking and everything else you need to run your firm.
          </p>
      ...
      <section className="py-8 md:py-12" style={{ background: "#0a0f1c" }}>
        <div ref={timelineRef} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { icon: Upload, step: "1", title: "Export from Harvest", desc: "Export your clients, projects, and time entries as CSV files from Harvest's admin panel." },
      ...
      <section className="py-8 md:py-12" style={{ background: "linear-gradient(180deg, #0f172a 0%, #0a0f1c 100%)" }}>
        <div ref={getRef} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 fade-in-section">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-white" data-testid="what-you-get-heading">What the rest of your stack just became</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              { icon: Clock, title: "Invoicing from time entries", desc: "Generate invoices directly from approved billable hours. Line items link to individual time entries." },
              { icon: Shield, title: "Project profitability reports", desc: "Revenue minus labor cost minus expenses per project. Finally see which projects make money and which don't." },
              { icon: Zap, title: "Unlimited users", desc: "No $12/user/month. Add your entire team — team members, employees, partners — on any plan." },
      ...
      <section className="py-10 md:py-14" style={{ background: "#0a0f1c" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to switch from Harvest?</h2>
          <p className="text-lg mb-10" style={{ color: "rgba(255,255,255,0.5)" }}>
            14-day free trial. Full access. Import your Harvest data in minutes.
          </p>
          <Link href="/signup">
